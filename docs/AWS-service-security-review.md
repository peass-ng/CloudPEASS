...
The 2026-09-10 campaign completed the service-by-service pass over all 455 prefixes: 138 are
`validated`, 159 are `no_new_positive`, 158 are precisely `blocked`, and none remain `queued` or
